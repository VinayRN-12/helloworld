		...
		<div class="container">
			...
			<div class="top_nav_right">
				<div class="cart box_1">
                            ...
                            <h1>Price <%=price%></h1>
                            <h1>MRP Price <%=mrp_price%></h1>
        
                        <div>
<div class="imageContainer">Capture Face Photo and AI will apply the product on your face   <%=productName%></div>
        <div class="container">   
          
                   
                        
	<div><video id="videoID" autoplay style="border: 1px solid red; margin-left: 240px; margin-top: 100px;"></video></div>
	<div><canvas id="canvasID" style="border: 1px solid black;margin-left: 972px;margin-top: -400px;width: 869px;height: 684px;margin-bottom: 20px;"></canvas></div>
   	<div>
            <input type="button" value="Capture" onclick="capture()" style="width: 200px; height: 30px; margin-left: 286px;"/>
            <input type="button" value="Send" onclick="send()" style="width: 200px; height: 30px; margin-left: 206px;"/>
	...
	function send()
			...
			//xmlhttp.open("POST", "ImageReceive.jsp?product_category="+product_category+"&blue="+blue+"&green="+green+"&red="+red, true);
			xmlhttp.open("POST", "ImageReceive.jsp", true);
         ...
         //  yo.push(document.getElementById("aa").value)
            }
          }
           //   xmlhttp.open("POST", "ImageReceive.jsp?model="+model, true);
	    //  xmlhttp.send(imageData);              
        }
...
<!--        <form action="Check.jsp" method="post">
           ...
           <table>
                <tr>  <td>   <input type="text" name="result" id="result" /></td>
                  
                    <td><input type="submit" value="submit" style=" margin-left: 106px;"></select></td>
                
                    <td><input type="hidden" name="aaa" id="aaa" style=" margin-left: 106px;"</td>
...
<!--                        <form action="Check.jsp" method="get">
                             <input type="text" name="aaa" id="aaa"  style=" margin-left: 106px;"/> 
                            <input type="submit" value="submit" style=" margin-left: 106px;"/>
          ...
          <div id="ms" style=" color: red;font-size: 50px; margin-left: 806px; margin-top:0;"></div>
</body>
</html>