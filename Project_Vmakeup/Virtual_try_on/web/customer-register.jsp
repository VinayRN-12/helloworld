					...
					<div class="login">
						<div class="login-bottom">
							...
							<form action="AddCustomer" method="post">
								...
								<div class="sign-up">
									<h4>Email :</h4>
									<input type="email" placeholder="Type here" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="Insert valid email id" required
								...
								<div class="sign-up">
									<h4>Phone :</h4>
									<input type="text" placeholder="Type here" pattern="[6789][0-9]{9}" title="Mobile No should start with 6/7/8/9 and 10 digit" required
