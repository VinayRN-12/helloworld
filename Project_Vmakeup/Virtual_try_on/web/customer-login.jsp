		...
		<div class="modal-content modal-info">
			...
			<div class="modal-body modal-spa">
				<div class="login-grids">
					<div class="login">
						<div class="login-right">
							...
							<form action="CustomerLogin" method="post">
								<div class="sign-in">
									<h4>Email :</h4>
									<input type="email" value="" style="width: 680px;" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="Insert valid email id" required
										name="email"/>
								</div>
								<div class="sign-in">
									<h4>Password :</h4>
					...
					<p>
						<a href="customer-register.jsp">New to Virtual Try On? Create an
							account</a>
					</p>
				</div>
			</div>
