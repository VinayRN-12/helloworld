					...
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<form role="form" action="AddProducts" method="post"
								...
								<div class="form-group">
									<label>Price</label> <input class="form-control" type="number" required
										name="price" />
								</div>
								<div class="form-group">
