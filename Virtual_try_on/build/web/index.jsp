		...
		<div id="visual">
			<div class="slide-visual">
				...
				<ul class="slide-group">
					<li><img class="img-responsive" src="images/img-1.jpg"
						alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="images/img-2.jpg"
						alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="images/img-3.jpg"
						alt="Dummy Image" /></li>
				</ul>
				...
				<div class="script-wrap">
					<ul class="script-group">
						<li><div class="inner-script">
								<img class="img-responsive" src="images/imgg-1.jpg"
									alt="Dummy Image" />
							</div></li>
						<li><div class="inner-script">
								<img class="img-responsive" src="images/imgg-2.jpg"
									alt="Dummy Image" />
							</div></li>
						<li><div class="inner-script">
								<img class="img-responsive" src="images/imgg-3.jpg"
									alt="Dummy Image" />
							</div></li>
					</ul>
		...
		<div class="container">
			<ul>
				...
				<li><span class="glyphicon glyphicon-envelope"
					aria-hidden="true"></span><a href="mailto:info@example.com">makup@virtualtryon.com</a></li>
			</ul>
		</div>
	</div>
