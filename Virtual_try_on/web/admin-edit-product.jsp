								...
								<div class="form-group">
									<label>Status</label> <select class="form-control"
										...
										<option>In-Active</option></select>
                                                                ...
                                                                <div class="form-group">
									<label>Blue Color Code</label> <input class="form-control"
										type="number" name="blue" value="<%=updateResult.getString("blue")%>" required/>
								</div>
                                                            <div class="form-group">
									<label>Green Color Code</label> <input class="form-control"
										type="number" name="green" value="<%=updateResult.getString("green")%>" required/>
                                                            <div class="form-group">
									<label>Red Color Code</label> <input class="form-control"
										type="number" name="red" value="<%=updateResult.getString("red")%>" required/>
								</div>
